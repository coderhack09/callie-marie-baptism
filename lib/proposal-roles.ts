...
const DEFAULT_HONOR_ATTENDANT_DESCRIPTIONS: Record<HonorAttendantTitle, string> = {
  "Matron of Honor":
    "To stand beside the bride with love and grace — lending a steady hand through every step of the day.",
  "Maid of Honor":
    "To stand beside the bride with love and loyalty — lending a steady hand through every step of the day.",
}
